...
if(isset($_SESSION['RAWMATS_DATA_SUM']))
{
	$data = $_SESSION['RAWMATS_DATA_SUM'];
	var_dump($data);
}
//	var_dump($_SESSION['RAWMATS_DATA_SUM']);
// $storeFunction->GenerateRawmatsSumData($year,$month,$branch,$conn);
?>
<style>
...
<?php
	...
	{
		$b=0;$a=0;$v_beg_total=0;$v_stkin_total=0;$v_transfer_total=0;$v_ending_total=0;
...
?>						
						<tr>
							...
							<!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
								<table style="width: 100%;border-collapse:collapse" cellpadding="0" cellspacing="0">
									<tr class="qty-box-data">
										<td style="border-right:1px solid #232323"><?php echo $storeFunction->GetRawmatsSumData('beginning',$year,$month,$branch,$db)?></td>
										<td style="border-right:1px solid #232323"><?php echo $storeFunction->GetRawmatsSumData('stock_in',$year,$month,$branch,$db)?></td>
										<td style="border-right:1px solid #232323"><?php echo $storeFunction->GetRawmatsSumData('transfer_out',$year,$month,$branch,$db)?></td>
										<td><?php echo $storeFunction->GetRawmatsSumData('ending',$year,$month,$branch,$db)?></td>
									</tr>
								</table>
							<!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
							...
							<td>
								...
								<table style="width: 100%;border-collapse:collapse" cellpadding="0" cellspacing="0">
									<tr class="qty-box-data">
										<td style="border-right:1px solid #232323"><?php echo $storeFunction->GetRawmatsSumData('beginning_amount',$year,$month,$branch,$db)?></td>
										<td style="border-right:1px solid #232323"><?php echo $storeFunction->GetRawmatsSumData('stock_in_amount',$year,$month,$branch,$db)?></td>
										<td style="border-right:1px solid #232323"><?php echo $storeFunction->GetRawmatsSumData('transfer_amount',$year,$month,$branch,$db)?></td>
										<td><?php echo $storeFunction->GetRawmatsSumData('ending_amount',$year,$month,$branch,$db)?></td>
									</tr>
								</table>
							<!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
							</td>
...
<?php 
						$v_beg_total += $storeFunction->GetRawmatsSumData('beginning_amount',$year,$month,$branch,$db);
						$v_stkin_total += $storeFunction->GetRawmatsSumData('stock_in_amount',$year,$month,$branch,$db);
						$v_transfer_total += $storeFunction->GetRawmatsSumData('transfer_amount',$year,$month,$branch,$db);
						$v_ending_total += $storeFunction->GetRawmatsSumData('ending_amount',$year,$month,$branch,$db);
} ?>
						<tr>
							<td>
								<!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
								<tr>
							<td style="width:230px;text-align:center;font-weight:600">TOTAL AMOUNT</td>
							<td>
							<!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
								<table style="width: 100%;border-collapse:collapse" cellpadding="0" cellspacing="0">
									<tr class="qty-box-data">
							...
							<td>
								...
								<table style="width: 100%;border-collapse:collapse" cellpadding="0" cellspacing="0">
									<tr class="qty-box-data">
										<td style="border-right:1px solid #232323"><?php echo $v_beg_total?></td>
										<td style="border-right:1px solid #232323"><?php echo $v_stkin_total?></td>
										<td style="border-right:1px solid #232323"><?php echo $v_transfer_total?></td>
										<td><?php echo $v_ending_total?></td>
									</tr>
								</table>
							<!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
							</td>
...
<?php } else { ?>
						<tr>
							<td colspan="4"><i class="fa fa-bell"></i>&nbsp;&nbsp;NO BRANCH FOUND</td>
						</tr>
<?php } ?>												
					</table>
				<!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->					
