...
if($mode=='c10cc6b684e1417e8ffa924de1e58373')
{
    ...
    { 
		...
		if($void == 0)
		{
			echo checkWMSManager($idcode,$db);
			if(checkWMSManager($idcode,$db) != '')		
			{
				$_SESSION['wms_user_recipient'] = checkWMSManager($idcode,$db);
			}
...
function checkWMSManager($idcode,$db)
{
	$checkManager = "SELECT * FROM wms_user_recipient WHERE idcode='$idcode'";
